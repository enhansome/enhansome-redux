...
* [Spectacle - ReactJS based Presentation Library](https://github.com/FormidableLabs/spectacle) ⭐ 10,162 | 🐛 77 | 🌐 TypeScript | 📅 2026-09-24
...
* Middlewares
  ...
  * [**react-redux** - React bindings for Redux](https://github.com/rackt/react-redux) ⭐ 23,425 | 🐛 40 | 🌐 TypeScript | 📅 2026-09-24
...
* Tools
  ...
  * [**redux-devtools** - DevTools for Redux with hot reloading, action replay, and customizable UI](https://github.com/gaearon/redux-devtools) ⭐ 14,368 | 🐛 142 | 🌐 TypeScript | 📅 2026-09-24
  ...
  * [**redux-saga-requests** - Redux-Saga addon to simplify handling of AJAX requests. It supports Axios and Fetch API.](https://github.com/klis87/redux-saga-requests) ⭐ 366 | 🐛 108 | 🌐 JavaScript | 📅 2026-09-24
...
* Frameworks
  ...
  * [**Easy Peasy** - Easy peasy redux-powered state management](https://github.com/ctrlplusb/easy-peasy) ⭐ 5,041 | 🐛 27 | 🌐 JavaScript | 📅 2026-06-30
...
* [**mobx** - Simple, scalable state management](https://github.com/mobxjs/mobx) ⭐ 28,214 | 🐛 45 | 🌐 TypeScript | 📅 2026-09-24
...
* Tools
  * [backbone-redux — The easy way to keep your backbone collections and redux store in sync](https://github.com/redbooth/backbone-redux) ⭐ 189 | 🐛 4 | 🌐 JavaScript | 📅 2026-09-24
...
* [react\_on\_rails gem](https://github.com/shakacode/react_on_rails) ⭐ 5,189 | 🐛 119 | 🌐 Ruby | 📅 2026-09-24
