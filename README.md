...
* [Sound Redux - a simple Soundcloud client](https://github.com/andrewngu/sound-redux) ⭐ 4,977 | 🐛 71 | 🌐 JavaScript | 📅 2022-12-10
...
* [**react-boilerplate** - Performance orientated, offline-first boilerplate feat. hot-reloading, PostCSS and the best developer experience.](https://github.com/mxstbr/react-boilerplate) ⭐ 29,484 | 🐛 140 | 🌐 JavaScript | 📅 2023-03-23
...
* [**react-production-starter** - React boilerplate with isomorphic rendering, async react-router routes, async redux reducers, async data fetching, and code-splitting.](https://github.com/jaredpalmer/react-production-starter) ⭐ 11,023 | 🐛 135 | 🌐 JavaScript | 📅 2024-03-11 :metal: :fire:
...
* Middlewares
  ...
  * [**redux-logger** - Logger middleware for Redux](https://github.com/fcomb/redux-logger) ⭐ 5,717 | 🐛 58 | 🌐 JavaScript | 📅 2020-08-20
...
* Tools
  ...
  * [**redux-devtools** - DevTools for Redux with hot reloading, action replay, and customizable UI](https://github.com/gaearon/redux-devtools) ⭐ 14,367 | 🐛 230 | 🌐 TypeScript | 📅 2026-09-04
...
* [react\_on\_rails gem](https://github.com/shakacode/react_on_rails) ⭐ 5,191 | 🐛 109 | 🌐 Ruby | 📅 2026-09-04
