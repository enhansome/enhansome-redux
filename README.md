...
* Tools
  ...
  * [**redux-devtools** - DevTools for Redux with hot reloading, action replay, and customizable UI](https://github.com/gaearon/redux-devtools) ⭐ 14,369 | 🐛 233 | 🌐 TypeScript | 📅 2026-09-15
  ...
  * [**redux-saga-requests** - Redux-Saga addon to simplify handling of AJAX requests. It supports Axios and Fetch API.](https://github.com/klis87/redux-saga-requests) ⭐ 366 | 🐛 108 | 🌐 JavaScript | 📅 2026-09-15
...
* [**mobx** - Simple, scalable state management](https://github.com/mobxjs/mobx) ⭐ 28,207 | 🐛 58 | 🌐 TypeScript | 📅 2026-09-14
...
* [electron-react-boilerplate (Electron + Redux + Hot Reload)](https://github.com/chentsulin/electron-react-boilerplate) ⭐ 24,253 | 🐛 197 | 🌐 TypeScript | 📅 2026-09-09
...
* [react\_on\_rails gem](https://github.com/shakacode/react_on_rails) ⭐ 5,189 | 🐛 105 | 🌐 Ruby | 📅 2026-09-15
* [React Webpack Rails Tutorial Using Redux](https://github.com/shakacode/react-webpack-rails-tutorial) ⭐ 1,719 | 🐛 35 | 🌐 JavaScript | 📅 2026-09-15
